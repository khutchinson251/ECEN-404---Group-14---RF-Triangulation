...
def _tile_file(i: int, j: int, zoom: int, key: str) -> bytes:
    ...
    url = f"https://api.maptiler.com/maps/hybrid/{zoom}/{j}/{i}.jpg?key={key}"
    #https://api.maptiler.com/tiles/satellite-v2/{zoom}/{j}/{i}.jpg?key={key}
...
if __name__ == "__main__":
    ...
    # plt.imshow(image)
    # plt.show()
    x = GPS_to_mercator( 30.62550842898528, -96.3353954198505)
    z = x[0]*512
    m = x[1]*512
    print(x)
    print(z, m)
